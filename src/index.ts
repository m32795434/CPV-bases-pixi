...
async function makeLoadScreen() {
    ...
    console.log("flowerTop.toLocal Point: ", flowerTop.toLocal(new Point()))//-300:-300
    console.log("flowerTop.toGlobal(new Point()): ", flowerTop.toGlobal(new Point()))
    console.log("flowerTop.parent.toGlobal(flowerTop.position)", flowerTop.parent.toGlobal(flowerTop.position))

    const aux1 = flowerTop.parent.toLocal(new Point(600, 600))
    // flowerTopStroke.position.copyFrom(aux);
    console.log("aux1 = flowerTop.parent.toLocal(new Point(600, 600))\n", aux1)
